package com.orderplatform.payment_service.aop;
...
public class IdempotencyAspect {
    ...
    public Object checkIdempotency(ProceedingJoinPoint joinPoint, Idempotent idempotent) throws Throwable {
        ...
        if (processedEventRepository.existsById(eventId)) {
            log.info("Event with ID {} has already been processed. Skipping execution.", eventId);
            return null;
        }
    ...
    private UUID resolveKey(ProceedingJoinPoint joinPoint, String key) {
        ...
        return expressionParser.parseExpression(key).getValue(context, UUID.class);
    }
